...
const textareaVariants = cva(
  "bg-background ring-offset-background text-text placeholder:text-text-dim rounded-md focus-visible:ring-ring flex min-h-[80px] w-full text-xs focus-visible:outline-none ring-1 ring-neutral-300 disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
